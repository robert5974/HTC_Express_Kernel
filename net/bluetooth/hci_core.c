...
static void hci_init_req(struct hci_dev *hdev, unsigned long opt)
{
	...
	BT_DBG("finish send cmd HCI_OP_READ_LOCAL_FEATURES");

	/* Read Local Version */
	hci_send_cmd(hdev, HCI_OP_READ_LOCAL_VERSION, 0, NULL);
	BT_DBG("finish send cmd HCI_OP_READ_LOCAL_VERSION");

	/* Read Buffer Size (ACL mtu, max pkt, etc.) */
	hci_send_cmd(hdev, HCI_OP_READ_BUFFER_SIZE, 0, NULL);
	BT_DBG("finish send cmd HCI_OP_READ_BUFFER_SIZE,");
	...
	BT_DBG("finish send cmd HCI_OP_READ_BD_ADDR,");
	...
	BT_DBG("finish send cmd HCI_OP_READ_VOICE_SETTING,");
	...
	BT_DBG("finish send cmd HCI_OP_SET_EVENT_FLT,");

	/* Page timeout ~20 secs */
	param = cpu_to_le16(0x8000);
	hci_send_cmd(hdev, HCI_OP_WRITE_PG_TIMEOUT, 2, &param);
	BT_DBG("finish send cmd HCI_OP_WRITE_PG_TIMEOUT,");

	/* Connection accept timeout ~20 secs */
	param = cpu_to_le16(0x7d00);
	hci_send_cmd(hdev, HCI_OP_WRITE_CA_TIMEOUT, 2, &param);
	BT_DBG("finish send cmd HCI_OP_WRITE_CA_TIMEOUT,");
}
