...
static int express_update_charging_protect_flag(int ibat_ma, int vbat_mv, int temp_01c, BOOL* chg_allowed, BOOL* hchg_allowed, BOOL *temp_fault)
{
	static int pState = 0;
...
static struct msm_otg_platform_data msm_otg_pdata = {
	...
	.usb_oc_pin		= PM8058_GPIO_PM_TO_SYS(EXPRESS_H2W_CABLE_IN1),
	.usb_oc_irq		= MSM_GPIO_TO_INT(
				PM8058_GPIO_PM_TO_SYS(EXPRESS_H2W_CABLE_IN1)),
};
#endif
